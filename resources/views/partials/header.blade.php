...
<header class="sticky top-0 z-50">
    ...
    <div class="bg-white shadow-sm">
        <div class="nf-container flex h-20 items-center justify-between gap-4">
            {{-- Logo --}}
            ...
            <nav class="hidden items-center gap-7 lg:flex">
                @foreach ($navLinks as $link)
                    <a href="{{ $link['url'] }}"
                       class="text-sm font-semibold text-navy transition-colors hover:text-brand">
                        {{ $link['label'] }}
                    </a>
                @endforeach
            </nav>
    ...
    <div class="bg-brand text-white">
        <div class="nf-container py-2 text-center">
