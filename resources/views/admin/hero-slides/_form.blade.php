        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input id="sort_order" name="sort_order" type="number" min="0" max="9999" value="{{ old('sort_order', $slide->sort_order) }}" placeholder="Auto"
                           class="h-11 w-full rounded-lg border border-gray-300 bg-white px-3.5 text-sm text-navy-dark outline-none transition focus:border-brand focus:ring-2 focus:ring-brand/30">
                    <p class="mt-1 text-xs text-gray-400">Leave empty to place it automatically after the last one (a gap from a deleted slide is filled first). Lower numbers show first.</p>
                </div>
