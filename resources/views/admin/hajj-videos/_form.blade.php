{{-- Shared fields for create/edit. Expects $video (HajjVideo, possibly unsaved). --}}
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input id="title" name="title" type="text" value="{{ old('title', $video->title) }}" required
                           placeholder="Pilgrim Review — Hajj 2026"
    ...
    <div class="space-y-5">
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('admin.hajj-videos.index') }}" class="flex h-11 w-full items-center justify-center rounded-lg border border-gray-200 text-sm font-semibold text-navy transition hover:bg-gray-50">
                    Cancel
                </a>
            </div>
        </div>
