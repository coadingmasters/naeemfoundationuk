...
@section('content')
    ...
    <section id="enquire" class="relative overflow-hidden scroll-mt-24 bg-gradient-to-br from-navy via-navy to-navy-dark">
        ...
        <div class="nf-container relative grid items-center gap-10 py-14 lg:grid-cols-2 lg:gap-14 lg:pb-20 lg:pt-40">
                ...
                <div>
                    ...
                    <div class="mt-6 space-y-3 text-sm text-gray-700 sm:text-base">
                        ...
                        <p class="flex items-center gap-3">
                            ...
                            <a href="mailto:donate@naeemfoundation.co.uk" class="hover:text-brand">donate@naeemfoundation.co.uk</a>
                        </p>
                    </div>
                </div>
