...
class HajjVideoController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse|JsonResponse
    {
        ...
        return $this->uploadRedirect($request, 'admin.hajj-videos.index', 'Video added successfully.');
    }
    ...
    public function update(Request $request, HajjVideo $hajjVideo): RedirectResponse|JsonResponse
    {
        $data = $this->validateData($request);
        $data['is_active'] = $request->boolean('is_active');
        ...
        return $this->uploadRedirect($request, 'admin.hajj-videos.index', 'Video updated successfully.');
    }
