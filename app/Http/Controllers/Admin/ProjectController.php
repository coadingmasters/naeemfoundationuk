...
class ProjectController extends Controller
{
    ...
    /** Directory (relative to the web root) where project images are stored. */
    private const UPLOAD_DIR = 'images/projects';
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data['sort_order'] = $request->filled('sort_order')
            ...
            : $this->nextSortOrder(Project::class);
        $data['image'] = $this->storeUploadedImage($request->file('image'), self::UPLOAD_DIR, 'project');
    ...
    public function update(Request $request, Project $project): RedirectResponse
    {
        ...
        if ($request->hasFile('image')) {
            $this->deleteUploadedImage($project->image, self::UPLOAD_DIR);
            $data['image'] = $this->storeUploadedImage($request->file('image'), self::UPLOAD_DIR, 'project');
        }
