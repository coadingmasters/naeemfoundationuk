...
ssh -p 65002 u721035936@145.79.26.12 "cd ~/domains/naeemfoundation.qubexistech.com/naeemfoundation && git pull origin main && php artisan migrate --force && php artisan db:seed --force && php artisan view:clear && php artisan cache:clear"
